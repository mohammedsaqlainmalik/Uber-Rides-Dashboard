...
4.Dashboard Views:
Home: Landing page
navigation Overview: Vehicle-type selector has (Auto, Bike, Sedan, Premium, Uber XL) with per-segment breakdown of completed/cancelled/incomplete rides, monthly / quaterly completed bookings trend, and monthly revenue trend.
